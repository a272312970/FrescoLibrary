...
public interface FrescoController {
     ...
     */
    void loadView(String lowUrl, String url, int defaultResID, int mFailResID,int emptyResID);
     ...
     * @param defaultResID 默认图
     */
    void loadView(String url, int defaultResID, int failResID,int emptyResID);
     ...
     */
    void loadLocalImage(String path, int defaultRes, int failRes,int emptyResID);
