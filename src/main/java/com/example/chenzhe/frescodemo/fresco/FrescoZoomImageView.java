...
import com.example.chenzhe.frescodemo.fresco.zoomable.ZoomableDraweeView;
...
public class FrescoZoomImageView extends ZoomableDraweeView implements FrescoController, BaseFrescoImageView {
    ...
    @Override
    public void loadView(String lowUrl, String url, int defaultResID, int failRes,int emptyResID) {
        try {
            mThumbnailPath = null;
            mThumbnailUrl = url;
            ...
            if (!TextUtils.isEmpty(mThumbnailUrl)
                ...
                this.getHierarchy().setFailureImage(failRes);
    ...
    @Override
    public void loadView(String url, int defaultResID, int failRes,int emptyResID) {
        this.loadView(null, url, defaultResID,failRes,defaultResID);
    }
